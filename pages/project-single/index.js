            ...
            <div className="col col-lg-8 col-12">
              <div className="project-content">
                <div className="img-holder">
                  <img
                    src="https://raw.githubusercontent.com/RedaBourhdadi/honey-shop/refs/heads/main/public/Images/project-single/img-1.jpg"
                    alt=""
                  />
                </div>
                ...
                <div className="pagi">
                  <ul>
                    <li>
                      <Link href="/project-single">Previous</Link>
                    </li>
                    <li>
                      <Link href="/project-single">Next</Link>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="service-sidebar">
                <div className="widget project-info-widget">
                  ...
                  <ul>
                    ...
                    <li>
                      <span>Date: </span> 20 January 2022
                    </li>
                    <li>
                    ...
                    <li>
                      <span>live link : </span>{" "}
                      <Link href="/project-single">http://demo.com</Link>{" "}
                    </li>
                  </ul>
                </div>
              </div>
